...
public class NotuGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ListValue[0].transform.position = new Vector3(xpos_1, ypos, 100f);
        ListValue[1].transform.position = new Vector3(xpos_1, ypos, 110f);
        
        ListValue[2].transform.position = new Vector3(xpos_1, ypos, 120f);
        ListValue[3].transform.position = new Vector3(xpos_1, ypos, 130f);

        ListValue[4].transform.position = new Vector3(xpos_1, ypos, 140f);
        ListValue[5].transform.position = new Vector3(xpos_1, ypos, 150f);
        ListValue[6].transform.position = new Vector3(xpos_1, ypos, 160f);
        ListValue[7].transform.position = new Vector3(xpos_1, ypos, 200f);
        ListValue[8].transform.position = new Vector3(xpos_1, ypos, 230f);
        ListValue[9].transform.position = new Vector3(xpos_2, ypos, 230f);
        ListValue[10].transform.position = new Vector3(xpos_1, ypos, 240f);
